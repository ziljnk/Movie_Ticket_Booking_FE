...
<template>
    <VideoIframe ref="video-iframe-component" :videoUrl="isOpenIframe ? movieDetail?.trailer : ''"
        ...
        <div id="movieContent">
            ...
            <div id="movieDescription">
                ...
                <div class="des-line">
                    ...
                    <p v-if="movieDetail.publishDate" class="des-movieInfo"> {{ formatDate(movieDetail?.publishDate) }}
                    </p>
                </div>
                <div class="des-line">
                    <h5 class="des-movieTitle">End:</h5>
                    <p v-if="movieDetail.endDate" class="des-movieInfo"> {{ formatDate(movieDetail?.endDate) }}
                    </p>
                </div>
                <div class="des-line">
                ...
                <img style="width: 48px; margin-bottom: 5vh;"
                    :src="movieDetail && movieDetail.type === '2D' ? require('@/assets/png/2dMovie.png') : require('@/assets/png/3dMovie.png')" />
